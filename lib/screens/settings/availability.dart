            ...
            onTap: () {
              _selectedParkingSpot != null
                  ...
                  : _scafoldkey.currentState.showSnackBar(SnackBar(
                      content: Text('Please Select a parking spot'),
                    ));
            }),
      ),
      body: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Align(
              child: Text(
                "Select Your Parking Spot".toUpperCase(),
            ...
            Align(
              child: Text(
                "*only your verfied parking will be available here"
                    .toUpperCase(),
                style: _hintText,
              ),
              alignment: Alignment.topLeft,
            ...
            Row(
              children: <Widget>[
                Padding(
                  child: InkResponse(
                    child: Text(
                        'From : ${_selectedFromTime.hour}:${_selectedFromTime.minute}'),
            ...
            Row(
              children: <Widget>[
                Padding(
                  child: InkResponse(
                    child: Text(
                        'To : ${_selectedToTimie.hour}:${_selectedToTimie.minute}'),
  ...
  void addAvailabliliy() {
    ...
    repository
        .makeAvailability(
            ...
            AvailableModel.forFirebase(SpotDate(
                '${_selectedDate.year}-${_selectedDate.month}-${_selectedDate.day}',
                _selectedFromTime.hour,
                _selectedToTimie.hour,
                parkingfee.round())))
        .then((onValue) {
      setState(() {
        isloading = false;
        onValue
            ? _scafoldkey.currentState.showSnackBar(
                SnackBar(content: Text('Your Parking has been Placed')))
            : _scafoldkey.currentState.showSnackBar(SnackBar(
