...
import 'package:parkit/screens/settings/payment/add_card.dart';
            ...
            Padding(
              padding: EdgeInsets.only(top: 40),
                ...
                children: <Widget>[
                  ...
                  GestureDetector(onTap: () {Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>AddCardPage()));}, child: Text("Credit or Debit Card")),
                ],
              ),
            ),
            Padding(
